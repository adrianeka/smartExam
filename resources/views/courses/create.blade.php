    ...
    <div class="bg-gray-100 text-gray-700 font-sans min-h-screen">
        <main class="flex-1 p-8">
            <nav class="text-xs text-gray-500 flex items-center space-x-2 mb-6">
                ...
                <i class="fa-solid fa-chevron-right text-[8px]"></i>
                <span class="text-blue-500 font-medium">Buat Mata Kuliah</span>
            </nav>

            <div class="bg-white rounded-xl shadow-xs border border-gray-200 p-8 max-w-3xl">
                
                <h2 class="text-xl font-bold text-gray-800 mb-8">Buat Mata Kuliah Baru</h2>
                ...
                <form action="{{ route('admin.courses.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Pemrograman Dasar" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-blue-500 focus:border-blue-500" required>
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2" for="description">Deskripsi</label>
                        <textarea id="description" name="description" rows="4" placeholder="Tuliskan deskripsi singkat mata kuliah ini..." class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-blue-500 focus:border-blue-500">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="flex items-center space-x-4 pt-4">
                        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm px-6 py-2.5 rounded-lg flex items-center shadow-xs transition">
                            <i class="fa-solid fa-save mr-2 text-xs"></i> Simpan
                        </button>
